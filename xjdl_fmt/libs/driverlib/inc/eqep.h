...
//
//*****************************************************************************
static inline void EQEP_setPositionCounterConfig(
    ...
    uint32_t base, EQEP_CAPCLKPrescale capPrescale, EQEP_UPEVNTPrescale evntPrescale)
{
    ...
    HWREGH(base + EQEP_O_QCAPCTL)
        = (HWREGH(base + EQEP_O_QCAPCTL) & ~(EQEP_QCAPCTL_UPPS_M | EQEP_QCAPCTL_CCPS_M))
...
static inline void EQEP_setComparePulseWidth(uint32_t base, uint16_t cycles)
{
    ...
    HWREGH(base + EQEP_O_QPOSCTL)
        = (HWREGH(base + EQEP_O_QPOSCTL) & ~(uint16_t)EQEP_QPOSCTL_PCSPW_M) | (cycles - 1U);
}
...
static inline void EQEP_setPositionInitMode(uint32_t base, uint16_t initMode)
{
    ...
    //
    HWREGH(base + EQEP_O_QEPCTL)
        = (HWREGH(base + EQEP_O_QEPCTL) & ~(EQEP_QEPCTL_IEI_M | EQEP_QEPCTL_SEI_M)) | initMode;
}
...
static inline void EQEP_setLatchMode(uint32_t base, uint32_t latchMode)
{
    ...
    //
    HWREGH(base + EQEP_O_QEPCTL)
        = (HWREGH(base + EQEP_O_QEPCTL) & ~(EQEP_QEPCTL_QCLM | EQEP_QEPCTL_IEL_M | EQEP_QEPCTL_SEL))
          | latchMode;
}
...
static inline void EQEP_setQMAModuleMode(uint32_t base, EQEP_QMAMode qmaMode)
{
    ...
    HWREGH(base + EQEP_O_QMACTRL)
        = (HWREGH(base + EQEP_O_QMACTRL) & ~EQEP_QMACTRL_MODE_M) | (uint16_t)qmaMode;
}
...
static inline void EQEP_setEmulationMode(uint32_t base, EQEP_EmulationMode emuMode)
{
    ...
    //
    HWREGH(base + EQEP_O_QEPCTL) = (HWREGH(base + EQEP_O_QEPCTL) & ~EQEP_QEPCTL_FREE_SOFT_M)
...
//
//*****************************************************************************
extern void EQEP_setCompareConfig(
...
//
//*****************************************************************************
extern void EQEP_setInputPolarity(
    uint32_t base, bool invertQEPA, bool invertQEPB, bool invertIndex, bool invertStrobe);
