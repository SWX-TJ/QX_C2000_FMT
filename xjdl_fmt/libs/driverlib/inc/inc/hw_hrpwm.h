...
#define HRPWM_O_TBCTL2         0x2U    // Time Base Control Register 2
#define HRPWM_O_TBCTR          0x8U    // Time Base Counter Register
#define HRPWM_O_TBSTS          0xAU    // Time Base Status Register
#define HRPWM_O_CMPCTL         0x10U   // Counter Compare Control Register
#define HRPWM_O_CMPCTL2        0x12U   // Counter Compare Control Register 2
#define HRPWM_O_DBCTL          0x18U   // Dead-Band Generator Control Register
#define HRPWM_O_DBCTL2         0x1AU   // Dead-Band Generator Control Register 2
#define HRPWM_O_AQCTL          0x20U   // Action Qualifier Control Register
#define HRPWM_O_AQTSRCSEL      0x22U   // Action Qualifier Trigger Event Source Select Register
#define HRPWM_O_PCCTL          0x28U   // PWM Chopper Control Register
#define HRPWM_O_VCAPCTL        0x30U   // Valley Capture Control Register
#define HRPWM_O_VCNTCFG        0x32U   // Valley Counter Config Register
#define HRPWM_O_HRCNFG         0x40U   // HRPWM Configuration Register
#define HRPWM_O_HRPWR          0x42U   // HRPWM Power Register
#define HRPWM_O_HRMSTEP        0x4CU   // HRPWM MEP Step Register
#define HRPWM_O_HRCNFG2        0x4EU   // HRPWM Configuration 2 Register
#define HRPWM_O_HRPCTL         0x5AU   // High Resolution Period Control Register
#define HRPWM_O_TRREM          0x5CU   // HRPWM High Resolution Remainder Register
#define HRPWM_O_GLDCTL         0x68U   // Global PWM Load Control Register
#define HRPWM_O_GLDCFG         0x6AU   // Global PWM Load Config Register
#define HRPWM_O_EPWMXLINK      0x70U   // EPWMx Link Register
#define HRPWM_O_AQCTLA         0x80U   // Action Qualifier Control Register For Output A
#define HRPWM_O_AQCTLA2        0x82U   // Additional Action Qualifier Control Register For Output A
#define HRPWM_O_AQCTLB         0x84U   // Action Qualifier Control Register For Output B
#define HRPWM_O_AQCTLB2        0x86U   // Additional Action Qualifier Control Register For Output B
#define HRPWM_O_AQSFRC         0x8EU   // Action Qualifier Software Force Register
#define HRPWM_O_AQCSFRC        0x92U   // Action Qualifier Continuous S/W Force Register
#define HRPWM_O_DBREDHR        0xA0U   // Dead-Band Generator Rising Edge Delay High Resolution
                                       // Mirror Register
#define HRPWM_O_DBRED          0xA2U   // Dead-Band Generator Rising Edge Delay High Resolution
                                       // Mirror Register
#define HRPWM_O_DBFEDHR        0xA4U   // Dead-Band Generator Falling Edge Delay High Resolution
                                       // Register
#define HRPWM_O_DBFED          0xA6U   // Dead-Band Generator Falling Edge Delay Count Register
#define HRPWM_O_TBPHS          0xC0U   // Time Base Phase High
#define HRPWM_O_TBPRDHR        0xC4U   // Time Base Period High Resolution Register
#define HRPWM_O_TBPRD          0xC6U   // Time Base Period Register
#define HRPWM_O_CMPA           0xD4U   // Counter Compare A Register
#define HRPWM_O_CMPB           0xD8U   // Compare B Register
#define HRPWM_O_CMPC           0xDEU   // Counter Compare C Register
#define HRPWM_O_CMPD           0xE2U   // Counter Compare D Register
#define HRPWM_O_GLDCTL2        0xE8U   // Global PWM Load Control Register 2
#define HRPWM_O_SWVDELVAL      0xEEU   // Software Valley Mode Delay Register
#define HRPWM_O_TZSEL          0x100U   // Trip Zone Select Register
#define HRPWM_O_TZDCSEL        0x104U   // Trip Zone Digital Comparator Select Register
#define HRPWM_O_TZCTL          0x108U   // Trip Zone Control Register
#define HRPWM_O_TZCTL2         0x10AU   // Additional Trip Zone Control Register
#define HRPWM_O_TZCTLDCA       0x10CU   // Trip Zone Control Register Digital Compare A
#define HRPWM_O_TZCTLDCB       0x10EU   // Trip Zone Control Register Digital Compare B
#define HRPWM_O_TZEINT         0x11AU   // Trip Zone Enable Interrupt Register
#define HRPWM_O_TZFLG          0x126U   // Trip Zone Flag Register
#define HRPWM_O_TZCBCFLG       0x128U   // Trip Zone CBC Flag Register
#define HRPWM_O_TZOSTFLG       0x12AU   // Trip Zone OST Flag Register
#define HRPWM_O_TZCLR          0x12EU   // Trip Zone Clear Register
#define HRPWM_O_TZCBCCLR       0x130U   // Trip Zone CBC Clear Register
#define HRPWM_O_TZOSTCLR       0x132U   // Trip Zone OST Clear Register
#define HRPWM_O_TZFRC          0x136U   // Trip Zone Force Register
#define HRPWM_O_ETSEL          0x148U   // Event Trigger Selection Register
#define HRPWM_O_ETPS           0x14CU   // Event Trigger Pre-Scale Register
#define HRPWM_O_ETFLG          0x150U   // Event Trigger Flag Register
#define HRPWM_O_ETCLR          0x154U   // Event Trigger Clear Register
#define HRPWM_O_ETFRC          0x158U   // Event Trigger Force Register
#define HRPWM_O_ETINTPS        0x15CU   // Event-Trigger Interrupt Pre-Scale Register
#define HRPWM_O_ETSOCPS        0x160U   // Event-Trigger SOC Pre-Scale Register
#define HRPWM_O_ETCNTINITCTL   0x164U   // Event-Trigger Counter Initialization Control Register
#define HRPWM_O_ETCNTINIT      0x168U   // Event-Trigger Counter Initialization Register
#define HRPWM_O_DCTRIPSEL      0x180U   // Digital Compare Trip Select Register
#define HRPWM_O_DCACTL         0x186U   // Digital Compare A Control Register
#define HRPWM_O_DCBCTL         0x188U   // Digital Compare B Control Register
#define HRPWM_O_DCFCTL         0x18EU   // Digital Compare Filter Control Register
#define HRPWM_O_DCCAPCTL       0x190U   // Digital Compare Capture Control Register
#define HRPWM_O_DCFOFFSET      0x192U   // Digital Compare Filter Offset Register
#define HRPWM_O_DCFOFFSETCNT   0x194U   // Digital Compare Filter Offset Counter Register
#define HRPWM_O_DCFWINDOW      0x196U   // Digital Compare Filter Window Register
#define HRPWM_O_DCFWINDOWCNT   0x198U   // Digital Compare Filter Window Counter Register
#define HRPWM_O_DCCAP          0x19EU   // Digital Compare Counter Capture Register
#define HRPWM_O_DCAHTRIPSEL    0x1A4U   // Digital Compare AH Trip Select
#define HRPWM_O_DCALTRIPSEL    0x1A6U   // Digital Compare AL Trip Select
#define HRPWM_O_DCBHTRIPSEL    0x1A8U   // Digital Compare BH Trip Select
#define HRPWM_O_DCBLTRIPSEL    0x1AAU   // Digital Compare BL Trip Select
#define HRPWM_O_EPWMLOCK       0x1F4U   // EPWM Lock Register
#define HRPWM_O_HWVDELVAL      0x1FAU   // Hardware Valley Mode Delay Register
#define HRPWM_O_VCNTVAL        0x1FCU   // Hardware Valley Counter Register
