...
//
#define ERAD_getBusCompInstance(base) (1U << ((base >> 8U) & 0x7U))
#define ERAD_getCounterInstance(base) ((1U << ((base >> 8U) & 0x3U)) << 8U)

//
// Macro function to get the HWBP event number from the base address
//
#define ERAD_BUSCOMP_BASE_TO_EVENT(base) ((base >> 8U) & 0x07U)
...
//
//*****************************************************************************
STATIC_INLINE bool ERAD_isValidBusCompBase(uint32_t base)
{
    return ((base == ERAD_HWBP1_BASE) || (base == ERAD_HWBP2_BASE) || (base == ERAD_HWBP3_BASE)
            || (base == ERAD_HWBP4_BASE) || (base == ERAD_HWBP5_BASE) || (base == ERAD_HWBP6_BASE)
            || (base == ERAD_HWBP7_BASE) || (base == ERAD_HWBP8_BASE));
}
...
//
//*****************************************************************************
STATIC_INLINE bool ERAD_isValidCounterBase(uint32_t base)
{
    return ((base == ERAD_COUNTER1_BASE) || (base == ERAD_COUNTER2_BASE)
            || (base == ERAD_COUNTER3_BASE) || (base == ERAD_COUNTER4_BASE));
}
...
//
//*****************************************************************************
STATIC_INLINE ERAD_Owner ERAD_getOwnership(void)
{
    //
    // Read Global Owner register and return value
    //
    return ((ERAD_Owner)((HWREGH(ERAD_GLOBAL_BASE + ERAD_O_GLBL_OWNER) & ERAD_GLBL_OWNER_OWNER_M)
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_setOwnership(ERAD_Owner owner)
{
    //
    // Set the Global Owner as owner
    //
    EALLOW;
    HWREGH(ERAD_GLOBAL_BASE + ERAD_O_GLBL_OWNER) = ((uint16_t)owner & ERAD_GLBL_OWNER_OWNER_M)
                                                   << ERAD_GLBL_OWNER_OWNER_S;
    EDIS;
}
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_resetCounter(uint16_t instances)
{
    //
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_enableModules(uint16_t instances)
{
    //
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_disableModules(uint16_t instances)
{
    //
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_initModule(ERAD_Owner owner)
{
    //
    ...
    //
    ERAD_disableModules(ERAD_INST_BUSCOMP1 | ERAD_INST_BUSCOMP2 | ERAD_INST_BUSCOMP3
                        | ERAD_INST_BUSCOMP4 | ERAD_INST_BUSCOMP5 | ERAD_INST_BUSCOMP6
                        | ERAD_INST_BUSCOMP7 | ERAD_INST_BUSCOMP8 | ERAD_INST_COUNTER1
                        | ERAD_INST_COUNTER2 | ERAD_INST_COUNTER3 | ERAD_INST_COUNTER4);

    //
    // Reset all counters
    //
    ERAD_resetCounter(
        ERAD_INST_COUNTER1 | ERAD_INST_COUNTER2 | ERAD_INST_COUNTER3 | ERAD_INST_COUNTER4);
}
...
//
//*****************************************************************************
STATIC_INLINE uint16_t ERAD_getHaltStatus(void)
{
    //
...
//
//*****************************************************************************
STATIC_INLINE uint16_t ERAD_getEventStatus(void)
{
    //
    // Read and return from the global register
    //
...
//
//*****************************************************************************
STATIC_INLINE ERAD_Status ERAD_getBusCompStatus(uint32_t base)
{
    //
    ...
    //
    return ((ERAD_Status)((HWREGH(base + ERAD_O_HWBP_STATUS) & ERAD_HWBP_STATUS_STATUS_M)
                          >> ERAD_HWBP_STATUS_STATUS_S));
}
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_clearBusCompEvent(uint32_t base)
{
    //
    // Check if the base is valid
    //
...
//
//*****************************************************************************
STATIC_INLINE ERAD_Status ERAD_getCounterStatus(uint32_t base)
{
    //
    // Check if the base is valid
    //
    ...
    //
    return ((ERAD_Status)((HWREGH(base + ERAD_O_CTM_STATUS) & ERAD_CTM_STATUS_STATUS_M)
                          >> ERAD_CTM_STATUS_STATUS_S));
}
//*****************************************************************************
//
...
//
//*****************************************************************************
extern void ERAD_configBusComp(uint32_t base, ERAD_BusComp_Config config_params);
...
//
//*****************************************************************************
extern void ERAD_configCounterInCountingMode(uint32_t base, ERAD_Counter_Config config_params);
...
//
//*****************************************************************************
extern void ERAD_configCounterInStartStopMode(uint32_t base, ERAD_Counter_Config config_params,
    ERAD_Counter_Input_Event start_event, ERAD_Counter_Input_Event stop_event);
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_enableCounterResetInput(uint32_t base, ERAD_Counter_Input_Event reset_event)
{
    //
    // Check if the base is valid
    //
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_disableCounterResetInput(uint32_t base)
{
    //
    // Check if the base is valid
    //
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_clearCounterEvent(uint32_t base)
{
    //
    // Check if the base is valid
    //
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_clearCounterOverflow(uint32_t base)
{
    //
    // Check if the base is valid
    //
...
//
//*****************************************************************************
STATIC_INLINE uint32_t ERAD_getCurrentCount(uint32_t base)
{
    //
    // Check if the base is valid
    //
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_setCurrentCount(uint32_t base, uint32_t value)
{
    //
...
//
//*****************************************************************************
STATIC_INLINE uint32_t ERAD_getMaxCount(uint32_t base)
{
    //
    // Check if the base is valid
    //
...
//
//*****************************************************************************
STATIC_INLINE void ERAD_setMaxCount(uint32_t base, uint32_t value)
{
    //
    // Check if owner is APPLICATION or NO_OWNER
    //
...
//
//*****************************************************************************
extern void ERAD_profile(ERAD_Profile_Params config_params);
...
extern void ERAD_enableInterruptOnAddressHit(
    ERAD_AddressHit_Params config_params, uint32_t busComp_base);
...
extern void ERAD_countAddressHits(
    ERAD_AddressHit_Params config_params, uint32_t busComp_base, uint32_t counter_base);
