#ifndef Q28004X_EPWM_H
#define Q28004X_EPWM_H
...
struct HRCAL_BITS
{
    Uint32 HRMSTEP_TEMP : 8;  // 7:0
    Uint32 rsvd1        : 20; // 27:8
    Uint32 CAL_DONE     : 1;  // 28
    Uint32 SAMPLE_VALID : 1;  // 29
    Uint32 SAMPLE_EN    : 1;  // 30
    Uint32 CAL_EN       : 1;  // 31
};
...
extern volatile struct HRCAL_REGS SFORegs;
extern volatile struct HRCAL_REGS SFOHHRRegs;
